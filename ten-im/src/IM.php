...
use Exception;
use Tencentim\TenIM\Exceptions\HttpException;
use Tencentim\TenIM\Exceptions\TenIMException;
use Tencentim\TenIM\Traits\HasHttpRequest;
...
class IM implements IMInterface
{
    ...
    public function userSig (string $userId){
            return $this->generateSign($userId);
    }
    /**
     * Build endpoint url.
     *
     ...
     * @return string
     */
    protected function generateSign(string $identifier, int $expires = 24 * 3600 * 365): string
    {
